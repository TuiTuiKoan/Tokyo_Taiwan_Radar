      ...
      {ORDER.map((key) => {
        ...
        return (
          <button
            ...
            onClick={() => setSort(key)}
            className={`flex-1 text-center relative z-10 px-1 sm:px-3 min-h-8 rounded-full whitespace-nowrap transition-colors hover:text-fg-strong focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand ${
              selected
