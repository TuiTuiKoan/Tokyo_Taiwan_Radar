  ...
  return (
    <div className="max-w-sm mx-auto mt-24">
      ...
      <button
        ...
        className="w-full border border-line-strong rounded-lg px-4 py-3 hover:bg-elevated transition mb-4 font-medium disabled:opacity-40 disabled:cursor-not-allowed"
      >
