...
function PerformerUrlIcon({ url }: { url: string }) {
  ...
  if (lower.includes("instagram.com")) {
    return (
      <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="currentColor" aria-label="Instagram">
  ...
  if (lower.includes("youtube.com") || lower.includes("youtu.be")) {
    return (
      <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="currentColor" aria-label="YouTube">
  ...
  if (lower.includes("twitter.com") || lower.includes("x.com")) {
    return (
      <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="currentColor" aria-label="X (Twitter)">
  ...
  if (lower.includes("facebook.com") || lower.includes("fb.com")) {
    return (
      <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="currentColor" aria-label="Facebook">
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-label="外部リンク">
