...
export function getSemanticSymbol(cat: string, variant: number, c: string, a: string): React.ReactNode {
  ...
  switch (cat) {
    case 'performing_arts':
      ...
      if (v===3) return <g><path d="M30 40 C30 20 70 20 70 40 C70 60 60 70 50 80 C40 70 30 60 30 40 Z" fill={c}/><path d="M30 50 L70 50 M40 60 L60 60" stroke={a} strokeWidth="3"/></g>; // shoe
    ...
    case 'senses':
      ...
      if (v===2) return <g><path d="M30 30 Q50 10 70 30 M25 45 Q50 20 75 45 M20 60 Q50 30 80 60" stroke={a} strokeWidth="6" strokeLinecap="round" fill="none"/></g>; // fingerprint
    ...
    case 'lifestyle_food':
      if (v===0) return <g><path d="M20 60 Q50 90 80 60 Z" fill={c}/><path d="M30 40 Q40 20 50 40 T70 40 M30 50 Q40 30 50 50 T70 50" stroke={a} strokeWidth="4" fill="none"/></g>; // noodles bowl
      ...
      if (v===3) return <g><path d="M20 50 Q40 20 80 40 Q90 60 60 80 Q30 70 20 50 Z" fill={c}/><path d="M30 50 C40 30 60 30 70 50" stroke={a} strokeWidth="4" fill="none"/></g>; // croissant organic
    ...
    case 'books_media':
      ...
      if (v===1) return <g><rect x="25" y="60" width="60" height="15" transform="rotate(-10 25 60)" fill={c}/><rect x="20" y="40" width="65" height="15" fill={a}/><rect x="30" y="20" width="50" height="15" transform="rotate(5 30 20)" fill={c}/></g>; // stacked books
      ...
      if (v===3) return <g><path d="M40 70 Q30 60 20 30 Q50 30 60 40 L70 80 Q50 80 40 70 Z" fill={c}/><line x1="45" y1="50" x2="65" y2="75" stroke={a} strokeWidth="3"/></g>; // quill
    ...
    case 'tech':
      ...
      if (v===3) return <g><path d="M50 80 L50 30" stroke="#3A261F" strokeWidth="6"/><path d="M30 40 Q50 10 70 40 M20 55 Q50 15 80 55" stroke={c} strokeWidth="5" strokeLinecap="round" fill="none"/><circle cx="50" cy="25" r="8" fill={a}/></g>; // antenna
      if (v===4) return <g><circle cx="50" cy="50" r="25" fill="none" stroke={c} strokeWidth="12" strokeDasharray="10 6"/><circle cx="50" cy="50" r="10" fill={a}/></g>; // cyber gear
    case 'tourism':
      ...
      if (v===3) return <g><circle cx="50" cy="50" r="30" fill="none" stroke={c} strokeWidth="8"/><circle cx="50" cy="50" r="18" fill="none" stroke={a} strokeWidth="6"/><circle cx="50" cy="50" r="6" fill="#3A261F"/></g>; // lens ring
    ...
    case 'gender':
      if (v===0) return <g><circle cx="40" cy="50" r="20" fill={c} opacity="0.8"/><circle cx="60" cy="50" r="20" fill={a} opacity="0.8"/></g>; // intersecting circles
      if (v===1) return <g><path d="M20 50 Q35 30 50 50 T80 50" stroke={c} strokeWidth="15" strokeLinecap="round" fill="none"/><path d="M20 70 Q35 50 50 70 T80 70" stroke={a} strokeWidth="15" strokeLinecap="round" fill="none"/></g>; // spectrum wave
      if (v===2) return <g><rect x="30" y="30" width="15" height="40" rx="7" transform="rotate(30 37 50)" fill={c}/><rect x="50" y="30" width="15" height="40" rx="7" transform="rotate(-30 57 50)" fill={a} opacity="0.9"/></g>; // hands overlapping
      ...
      if (v===4) return <g><polygon points="20,80 40,20 60,20 40,80" fill={c}/><polygon points="40,80 60,20 80,20 60,80" fill={a}/></g>; // diagonal stripes
    case 'geopolitics':
      ...
      if (v===2) return <g><ellipse cx="50" cy="65" rx="35" ry="10" fill={c}/><circle cx="30" cy="40" r="8" fill={a}/><circle cx="70" cy="40" r="8" fill={a}/></g>; // round table
    ...
    case 'lecture':
      ...
      if (v===4) return <g><polygon points="30,40 70,25 70,75 30,60" fill={c}/><path d="M25 40 Q15 50 25 60 Z" fill={a}/><line x1="45" y1="65" x2="45" y2="85" stroke="#3A261F" strokeWidth="6"/></g>; // megaphone
    case 'taiwan_japan':
      ...
      if (v===2) return <g><path d="M50 25 C65 25 65 45 50 45 C35 45 35 25 50 25 Z M50 45 C65 45 65 65 50 65 C35 65 35 45 50 45 Z" fill={c} transform="rotate(45 50 45)"/><circle cx="50" cy="45" r="5" fill={a}/></g>; // blossom
      if (v===3) return <g><path d="M20 40 Q50 10 80 40 L50 80 Z" fill={c}/><path d="M30 40 L50 80 M50 25 L50 80 M70 40 L50 80" stroke={a} strokeWidth="3"/></g>; // fan
    ...
    case 'business':
      ...
      if (v===2) return <g><polygon points="35,30 65,30 50,80" fill={a}/><polygon points="20,20 45,45 35,30" fill={c}/><polygon points="80,20 55,45 65,30" fill={c}/></g>; // tie
