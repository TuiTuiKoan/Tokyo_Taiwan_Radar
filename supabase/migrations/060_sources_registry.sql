...
('taiwan_kyokai','台湾協会','government','daily','https://taiwan-kyokai.or.jp/', 40),
('taioan_dokyokai','台湾同郷会','government','daily','https://taioan.fc2.page/', 50),
...
('kbc_cinema','KBC シネマ','cinema','daily','https://kbc-cinema.com/', 460),
...
('starcat_cinema','シネマスコーレ','cinema','daily','https://eiga.starcat.co.jp/', 500),
...
('amayaza','雨宮座','cinema','daily','https://amaya-za.com/', 550),
('theater_kino','シアターキノ','cinema','daily','https://theaterkino.net/', 560),
('theater_enya','シアターセンディアン','cinema','daily','https://theater-enya.com/', 570),
('ftip','FT inn','cinema','daily','https://www.ftip-japan.org/', 580),
('ciema','シネマ','cinema','daily','https://ciema.info/', 590),
('cineplaza','シネプラザ','cinema','daily','https://cineplaza.net/', 600),
('internet_museum','Internet Museum','cinema','daily','https://museum.or.jp/', 610),
('onariza','御成座','cinema','daily','http://onariza.oodate.or.jp/', 620),
...
('nagano_aioiza','長野アイオイ座','cinema','daily','http://www.naganoaioiza.com/', 650),
('cinemadict','Cinemadict','cinema','daily','https://www.cinemadict.com/', 660),
...
('iwafu','巖風','news','daily','https://www.iwafu.com/', 770),
...
('tsudoi_osaka','大阪集い','official','daily','https://tsudoi-jptw.jimdofree.com/', 990),
('ginsee','銀座シャラララ','official','daily','https://www.ginsee.jp/', 1000),
('startup_terrace','Startup Terrace','official','daily','https://www.startupterrace.tw/', 1010),
('johakyu','Johakyu','official','daily','https://johakyu.com/', 1020),
('otto','OTTO Gallery','official','daily','https://otto-extended.com/', 1030),
