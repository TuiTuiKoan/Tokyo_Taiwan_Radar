...
- Number migrations sequentially: `001`, `002`, … Latest is `075_field_corrections_audit.sql` (next = `076`). Previous milestones: `073_event_views_country.sql`, `074_auto_scraper_artifacts.sql`.
...
1. Number the file `NNN_descriptive_name.sql` (next = `076`)
